...
#ARGS 1
in_dir <- "/home/bparmentier/Data/Benoit/BELSPO_malaria/trend_and_harmonic_regression/outputs/output_testing_ts_05162019"
in_dir1 <- "/home/bparmentier/Data/Benoit/BELSPO_malaria/trend_and_harmonic_regression/data"

#ARGS 2
out_dir <- "/home/bparmentier/Data/Benoit/BELSPO_malaria/trend_and_harmonic_regression/outputs/output_testing_ts_05162019"
#ARGS 3
infile_name_raster <- "Ouagadougou_MOD13A1_006_NDVI_2001_2016.tif"
#ARGS 4
#start_date <- "2004-01-01"
start_date <- "2001-01-01"  #new data starts in November 2012
#ARGS 5
end_date <- NULL
#ARGS 6
create_out_dir_param=FALSE #create a new ouput dir if TRUE
#ARGS 7
...
infile_name_raster <- file.path(in_dir1,basename(infile_name_raster))
#
